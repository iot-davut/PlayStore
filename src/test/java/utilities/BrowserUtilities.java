...
public class BrowserUtilities {
    @Nullable
    public static void writeDataToIdsFile(String tip, String id) throws IOException {
        Properties props = new Properties();
        String propertiesFileName = "ids.properties";
        File f = new File(propertiesFileName);
        InputStream input = new FileInputStream(f);

        if (input != null) {
            props.load(input);
            props.setProperty(tip,id);
            OutputStream out = new FileOutputStream(f);
            props.store(out, null);
        }
    }
    @Nullable
    public static String readDataFromIdsFile(String tip){
